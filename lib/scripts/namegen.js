...
const Etl = {
  ...
  codasF: {"p": 1, "t":  4, "c":  7, "'": 1, "tz": 5, "tl": 6,
           "s": 2, "lh": 2, "sh": 2, "j": 2, "h": 1,
           "m": 1, "n":  2, "r":  1, "l": 2},
  initialV: .06,
  finalC: 1,
  swapOut: ["tztz","tztl","lhlh","tzs","lhh","ngk","ts","ph","hh",
            "tltl","tltz","ngng","tll","shs","shh","ngj","ngy","th","kh","jh",
            "pr","tr","cr","rw","wr","'r","r'",
            "'p","'t","'c","'tz","'tl","''","ci","ce","cki","cke"],
  swapIn:  ["tz",  "ttl", "lh",  "tz", "lh", "nk", "tz","pp","h",
            "tl",  "ttz", "ng",  "tl", "ss", "sh", "nj", "ny","tt","kk","h",
            "p", "t", "c", "r", "w", "r", "r",
...
const badnames = ["spamrat","allah","anal","anus","ass","asses","asshole","assholes","bastard","bastards","bitch","bitches","bimbo","bimbos","booger","boogers","boxers","bra","bras","briefs","bugger","buggered","buggers","bullshit","bung","bungs","butt","butts","butthole","buttholes","chinaman","chink","chinks","christ","cock","cocks","coon","coons","crap","crapped","craps","crip","cunt","damn","damnit","dick","dicks","dickhead","dickheads","dimwit","dimwits","drug","drugs","dung","dungs","dyke","dykes","fag","fags","faggot","faggots","fart","farts","fecal","feces","fuck","fucked","fucker","fucks","genital","genitalia","gimp","gimps","god","goddamn","goddamned","goddamnit","gods","gringo","gringos","gunk","gypsies","gypsy","gypsys","hag","hags","hate","hated","hater","hates","idiot","idiots","imbecile","imbeciles","injun","injuns","jesus","kike","kikes","killer","killers","kyke","kykes","lame","lamed","lamer","lames","lamest","meth","moron","morons","motherfucker","motherfuckers","murder","murderer","murdered","murders","nazi","nazis","nig","nigga","niggas","nigger","niggers","nigs","nimrod","nimrods","oreo","oreos","panties","pee","pees","penis","penises","phlegm","piss","pissed","pisser","pisses","poop","pooped","poops","porn","prick","pricks","puss","pusses","pussies","pussy","rape","raper","rapes","rapist","rectum","rectums","rectal","redskin","redskins","retard","retarded","retards","sambo","sambos","semen","shat","shemale","shemales","sheman","shit","shits","sissies","sissy","slut","sluts","snot","snots","spam","spams","spic","spics","spick","spicks","spik","spiks","spit","spits","squaw","squaws","stank","stink","stinks","suck","sucked","sucker","sucks","taint","taints","thong","thongs","tranny","trannies","twat","twats","twink","twinks","underpants","underwear","urinate","urinated","urinates","urine","urines","vagina","vaginal","vaginas","wetback","wetbacks","whore","whores","wuss","wusses","yahweh"];
...
function generateOneName(lang) {
  ...
  if (lang.gemsToKeep) { name = removeGems(name,lang.gemsToKeep); }
...
function getShape(lang) {
  ...
  for (j=0; j<numSyls; j++) {
    ...
    if (nextsyl.indexOf("F")>-1) { numCodas++; }
    if (nextsyl.indexOf("R")>-1) { numClusters++; }
    if (nextsyl.indexOf("W")>-1) { numHiatus++;  j++; }
    shape = shape + nextsyl;
  }
  let chance = Math.random();
